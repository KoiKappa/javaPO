...
public class App{
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(objetoConta.nome_correntista+" "+objetoConta.número_conta+" "+objetoConta.saldo);
        ...
        if (objetoConta.op==1){
            ...
            if (objetoConta.op_sq==1){
                ...
                System.out.println("Sua conta contem: "+soma);
            ...
            if ((objetoConta.op_sq!=1) && (objetoConta.op!=2)){
                System.out.println("Operação nao encontrada...");
            }
        }
        }   
